  ...
  <div class="container-fluid"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="http://chisdealhd.xyz/stream/">LIVE: <?php echo $live;?></a></li>
      </ul>
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="jumbotron">
        <h1 class="text-center">ChisdealHD Twitch Stream.</h1>
        <div class="row">
        </div>
        <div> </div>
        <div class="row">
        ...
        <p class="text-center">
       <iframe src="https://player.twitch.tv/?channel=chisdealhd" width="700" height="800" frameBorder="0">Browser not compatible.</iframe>
       <iframe src="https://www.twitch.tv/chisdealhd/chat?popout=" width="300" height="800" frameBorder="0">Browser not compatible.</iframe>
       <br>
       <center><p><a class="btn btn-primary btn-lg" href="http://twitch.tv/chisdealhd" role="button">Check out ChisdealHD Twitch Channel!</a></p></center>
       </p>
    </div>
</div>
<hr>
