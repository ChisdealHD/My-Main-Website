  ...
  <div class="container-fluid"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="http://chisdealhd.xyz/chat/index.php">Chat</a></li>
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="jumbotron">
        <h1 class="text-center">ChisdealHD Discord Chat.</h1>
        <div class="row">
        </div>
        <div> </div>
        <div class="row">
        ...
        <p class="text-center"><embed height='900' width='900' src='https://service.voakie.com/widgetbot/channel/?g=199884268195807233%7C204294599823458304%7C0%7C0%7C1%7C2%7C&bu=Click to join&bl=people in this guild' /></p>
    </div>
</div>
<hr>
<div class="container">
