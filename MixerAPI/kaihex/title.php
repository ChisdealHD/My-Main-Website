<?php 
    ...
    $url = "https://mixer.com/api/v1/channels/kaihex";
    ...
    $url3 = "https://mixer.com/api/v1/channels/kaihexfields=online";
...
<?php 
    ...
    $hosteetitle = $json123['name'];
    $beamid1 = $json123['id'];
	$titleshow = $json123['online'] == true ? $hosteetitle : $title;
?>
...
<body>
	...
	<h1><small id="Refresh"><?php echo "<br>Title: $titleshow</br>";?></small>
