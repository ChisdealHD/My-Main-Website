<?php 
    ...
    $url3 = "https://mixer.com/api/v1/channels/kaihex?fields=online";
...
<?php 
    ...
    $hosteegame = $json123['type']['name'];
    $beamid1 = $json123['id'];
	$gameshow = $json123['online'] == true ? $hosteegame : $game;
?>
...
<body>
	...
	<h1><small id="Refresh"><?php echo "<br>Game: $gameshow</br>";?></small>
