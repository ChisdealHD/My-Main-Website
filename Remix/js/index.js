...
{	
	if (currentIndex != index) { //Avoid to start over the audio by clicking on the current music and mute the audio
		...
		this.$.carousel.css({
			"background-image": "url(http://mediaplayer.chisdealhd.xyz/Remix/mp3/bg" + index + ".png)"
		});
		...
		this.$.music[0].setAttribute('src', 'http://mediaplayer.chisdealhd.xyz/Remix/mp3/' + index + '.mp3');
		this.changeMusic();
